...
if (\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('container')) {
    ...
    ->setIcon('EXT:winkelbach_distribution/Resources/Public/Icons/ge-2_col.svg')
...
\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\B13\Container\Tca\Registry::class)->configureContainer(
	...
	->setIcon('EXT:winkelbach_distribution/Resources/Public/Icons/Register/ge-3_col.svg')
	->setSaveAndCloseInNewContentElementWizard(false)
);
...
\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\B13\Container\Tca\Registry::class)->configureContainer(
	...
	->setIcon('EXT:winkelbach_distribution/Resources/Public/Icons/Register/ge-4_col.svg')
	->setSaveAndCloseInNewContentElementWizard(false)
);
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
        '*',
        'FILE:EXT:winkelbach_distribution/Configuration/FlexForms/TwoColumns.xml',
        'two_columns'
    );
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
        '*',
        'FILE:EXT:winkelbach_distribution/Configuration/FlexForms/ThreeColumns.xml',
        'three_columns'
    );
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
        '*',
        'FILE:EXT:winkelbach_distribution/Configuration/FlexForms/FourColumns.xml',
        'four_columns'
    );
