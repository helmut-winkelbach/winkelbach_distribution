...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:winkelbach_distribution/Resources/Private/Language/Backend.xlf:content_element.accordion',
        'description' => 'LLL:EXT:winkelbach_distribution/Resources/Private/Language/Backend.xlf:content_element.accordion.description',
        'value' => 'accordion',
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_bootstrappackage_accordion_item' => [
            'label' => 'LLL:EXT:winkelbach_distribution/Resources/Private/Language/Backend.xlf:accordion_item',
            'config' => [
                'type' => 'inline',
